	...
	<div class="info-content" id="apasinfo">
		...
		<div class="mini-clearfix info-box">
			<div class="mini-col-4">
				<input class="mini-buttonedit" labelField="true" label="统一社会信用代码"
					name="applyCardNumber" maxLength="18" required>
			</div>
			<div class="mini-col-4">
				<input class="mini-textbox" labelField="true" label="单位名称"
					name="applyName" maxLength="64" required>
			</div>
			<div class="mini-col-4">
				<input class="mini-textbox" labelField="true" label="法人代表"
					name="legalman" maxLength="64" required>
			</div>
		</div>
		<h3>联系人/待办人基本信息</h3>
		<div class="mini-clearfix info-box">
